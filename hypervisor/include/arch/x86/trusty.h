...
/* structure to save run_context of secure world */
struct secure_world_save_area {
	/* Secure World's running context
	 * Currently, Secure World is only running on 1 vcpu,
	 * so the saved_ctx indicates the vcpu0's run_context
	 * for secure world.
	 */
	struct run_context saved_ctx;
};
